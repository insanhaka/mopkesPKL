                                    ...
                                    <div class="card-body no-padding">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                @if(isset($pms[$pm['menuid']]))
                                                    @foreach ($pms[$pm['menuid']] as $pmc)
                                                    <tr>
                                                        <td class="pl-5">{!!$pmc['menuname']!!} ({!!$pmc['name']!!})</td>
                                                        @foreach($mans as $manc)
                                                            @if(isset($mais[$pmc['name']][$manc]))
                                                                <td align="center">
                                                                    <label>
                                                                    <input type="checkbox" class="{!! $manc !!}" name="permissionrole[]" value="{!! $mais[$pmc['name']][$manc] !!}" {{ (isset($rps[$mais[$pmc['name']][$manc]]))?"checked":"" }}>
                                                                    <span class="text"></span>
                                                                    </label>
                                                                </td>
                                                            @else
