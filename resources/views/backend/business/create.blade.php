                    ...
                    <div id="addform" style="display: none">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4 col-12">
                                ...
                                {!! Form::select('lapak_desa', $desparent, null,['id'=>'lapak_desa','class'=>'form-control selectku','style'=>'width: 100%;']) !!}
                            </div>
                            <div class="form-group col-lg-4 col-12">
                    ...
                    <div class="card-footer border-top">
                        <div class="row justify-content-between">
                            <div class="col-4 text-md-left text-center">
                                <button type="button" class="btn btn-primary" onclick="moreFields()">Tambah Data Usaha</button>
                            </div>
