...
<section class="section">
    ...
    <div class="section-body">
        ...
        <p class="section-lead">
            Daftar akun pengguna yang bisa mengakses aplikasi ini.
        </p>
        <div class="row">
            <div class="col-12">
                <div class="card">
                        ...
                        <table class="table table-striped dt-responsive" id="simpledatatable">
                            <thead>
                                <tr>
                                    ...
                                    <th>Username</th>
                                    <th width="120" class="cbfilter">Role</th>
                                    <th width="120" class="cbfilter">Market</th>
                                    <th width="120" class="cbfilter">Active</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{!! (is_null($data->market_id))?'All':$data->market->name !!}</td>
