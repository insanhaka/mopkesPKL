        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-primary">
                    {!!Form::open(['route'=>'admin.permission.store','class'=>'validate','id'=>'simpan','novalidate'=>''])!!}
                    <div class="card-body">
                        <div class="row">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#menu_id').on('change', function(e){
                e.preventDefault();
                var $this = $(this);
                var $target = $('#permission_name');
                $target.val("");
                if($this.val()!=''){
                    $.post( APP_URL_ADMIN +'/menu/geturimenu',{ "_token": "{{ csrf_token() }}", "menu_id": $this.val() } , function( data ) {
                        // console.log(data.uri.menu_uri);
                        $target.val(data.uri.menu_uri+'-');
                    });
                }
            });
        });
