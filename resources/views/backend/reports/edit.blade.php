...
<section class="section">
    ...
    <div class="section-body">
        ...
        <p class="section-lead">
            Form untuk edit <b>report</b>
        </p>
        <div class="row">
            <div class="col-12">
                <div class="card card-primary">
                    {!! Form::model($report, ['route' => ['admin.report.update', $report->id],'class'=>'form-horizontal validate','id'=>'simpan','novalidate'=>'']) !!}
                    <div class="card-body">
                        <div class="row">
                            {{-- Add Something Here --}}
                        </div>
